...
package com.dataartisans.flink.util.latency;
...
public class LatencyTester {
	...
	// Does not count the first 20 secs of the topology,
	// because that is noisy
	private long startingTime = 20 * 1000;
	// Writes every 30 secs
	...
	public void writeLog() {
		try {
			// Overwrites the file on every write
